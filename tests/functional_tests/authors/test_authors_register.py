...
class AuthorsRegisterTest(AuthorsBaseTest):
    ...
    def test_empty_last_name_error_message(self):
        ...
        self.test_empty_last_name_error_message(callback)
    ...
    def test_empty_username_error_message(self):
        ...
        self.test_empty_username_error_message(callback)
    ...
    def test_invalid_email_error_message(self):
        ...
        self.test_invalid_email_error_message(callback)
    ...
    def test_passwords_do_not_match(self):
        def callback(form):
            ...
            password1.send_keys('Prx@1234')
            password2.send_keys('Prx@1234xxx')
